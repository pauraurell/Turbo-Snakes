...
public class ServerUDP : MonoBehaviour
{
    ...
    public List<Objects> WorldObjects = new List<Objects>();
        ...
        while (true)
        {
            if (!client1.active)
            {
                try
                {
                    ...
                    packet.guid1 = WorldObjects[0].uid;
                    packet.guid2 = WorldObjects[1].uid;

                    packet.objects = WorldObjects;
    ...
    void Send()
    {
        ...
        while (true)
        {
            ...
            foreach(Objects go in WorldObjects)
            {
